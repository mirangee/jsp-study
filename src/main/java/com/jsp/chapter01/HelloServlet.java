...
@WebServlet("/hello") // 우리 웹 서버에 /hello 라는 URL로 요청이 오면 이 서블릿을 실행시켜라!
public class HelloServlet extends HttpServlet { // 1. HttpServlet을 상속 받는다.
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        w.flush(); // 브라우저로 지금까지 작성한 내용들을 내보낸 후 다음 응답을 위해 메모리 공간 비움.
        w.close();
    }
}
